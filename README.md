...
![版本](https://img.shields.io/badge/版本-v4.2.0-0a84ff?style=flat-square)
...
| 📱 **应用管理** | HTML 文件安装、批量/文件夹导入、应用隐藏/锁定、图标/颜色/大小自定义、应用信息全屏查看 |
| 📁 **数据持久化** | IndexedDB 存储引擎、一键备份/恢复（支持合并导入）、应用使用统计 |
| 🔧 **系统设置** | 背景壁纸（预设+本地上传）、三套主题（直角/玻璃/暗黑）、列数调节、启动动画、触摸震动 |
